...
2. В каждом новом/изменённом файле в `src/components/ui/` заменить импорт утилиты на `import { cn } from "@ui"`.
...
1. Реализовать компонент в `wrappers.tsx` (импорт примитива из `./PrimitiveName`, использование `cn` из `@ui`).
